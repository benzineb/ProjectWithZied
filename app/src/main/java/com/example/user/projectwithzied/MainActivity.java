...
public static String GareDepart;
    Integer IndexGareArrivee,IndexGareDepart;
    String headsign ;
    ...
    partir.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (dep.getSelectedItem() == arr.getSelectedItem()) {
               ...
               c = myDbHelper.query("stop_times,stops",new String[]{"departure_time"}, "stop_times.stop_id=stops.stop_id AND stops.stop_name="+GareDepart+" and trip_id<43 AND stop_times.stop_headsign="+headsign+"", null, null, null,"departure_time");
